# Generated by Django 6.0.3 on 2026-03-07 20:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isolation_policy', models.CharField(choices=[('open', 'Open'), ('isolated', 'Isolated'), ('inherit_only', 'Inherit Only'), ('visible_only', 'Visible Only')], default='open', max_length=20)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='app_org.orgunit')),
            ],
        ),
        migrations.CreateModel(
            name='Membership',
